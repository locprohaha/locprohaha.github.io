...
$form = array(
	'subject' => 'Payment page Form Submission',
	...
	'fields' => array(
		...
		'Email' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Email or Mobile Phone\' is required.',
				'format' => 'Field \'Email or Mobile Phone\' has an invalid email.'
			)
		),
		'custom_U60111' => array(
			'order' => 5,
		...
		'custom_U78103' => array(
			'order' => 3,
			'type' => 'string',
			'label' => 'Drop! Shop Number',
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Drop! Shop Number\' is required.'
			)
		),
		'custom_U78115' => array(
			'order' => 4,
			...
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Table Number\' is required.'
			)
		)
	)
);
